        ...
        <form onSubmit={e => handleSubmit(e)} className="login100-form">
          ...
          <div className="form-group">
            ...
            <div className="row bottom-layer">
              ...
              <div className="user1">
                <label htmlFor="childCWC" className="emp-id">Is married ?</label>
                <input
                  type="checkbox"
                  id="childCWC"
                  value={isMarried}
              ...
              <div className="user1">
                <label htmlFor="childCWC" className="emp-id">Has child ?</label>
                <input
                  type="checkbox"
                  id="childCWC"
                  value={hasChild}
              ...
              <div className="user1">
                <label htmlFor="childAge" className="emp-id">No of Children</label>
                <input
                  className="form-control"
                  type="number"
                  id="childAge"
